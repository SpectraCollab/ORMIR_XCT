...
def ipl_seg(
    input_image, lower_threshold, upper_threshold, value_in_range=127, voxel_size=0.0606964, sigma=0.5
):
    """
    ...
    seg = sitk.BinaryThreshold(smooth, lower_threshold, upper_threshold, value_in_range, 0)
    return seg
