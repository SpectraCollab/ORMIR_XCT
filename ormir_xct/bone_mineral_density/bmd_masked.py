...
def bmd_masked(image, image_units, background, mu_scaling, mu_water, rescale_slope, rescale_intercept):
    """
...
def main():
    ...
    parser.add_argument( 'image_seg', type=str, help='The input image mask (path + filename)' )
    ...
    parser.add_argument( 'mu_water', type=float, nargs='?', default='0.25', help='Linear attenuation of water (default = 0.25)' )
    parser.add_argument( 'rescale_slope', type=float, nargs='?', default='1600.0', help='Slope to scale to BMD (default = 1600.0)' )
    parser.add_argument( 'rescale_intercept', type=float, nargs='?', default='-390.0', help='Intercept to scale to BMD (default = -390.0)' )
    parser.add_argument( 'background', type=float, nargs='?', default='-1000', help='Background value for cropped images (default = -1000)' )
    ...
    mean, std = bmd_masked(masked_image, image_units, background_value, 
