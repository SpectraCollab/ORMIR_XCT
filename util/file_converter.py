...
from .sitk_itk import sitk_itk, itk_sitk
from .image_to_dicom import image_to_dicom
...
def file_converter(input_image, output_image) :
    ...
    if os.path.isdir(input_image) :
        ...
        elif os.path.isfile(input_image) and ('.nii' or '.mha' or '.mhd' or '.raw' or '.nrrd' in input_extension.lower()) :
